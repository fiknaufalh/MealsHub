...
function TableOrder({ data }: { data: Data }) {
    ...
    function endNumber() {
        if (currentPage == npage && (filteredRecords.length % recordsPerPage != 0)) {
        ...
        <div className="mx-12 w-11/12">
            ...
            <div className="font-nunito relative overflow-x-auto shadow-md sm:rounded-lg mt-6">
                <table className="w-full text-sm text-left rtl:text-right">
                            ...
                            <th scope="col" className="px-6 py-3">
                                <div className="flex items-center font-semibold">
                                    ...
                                    <SortButton
                                        ...
                                        onClick={() => changeSort("orderStatus")}
                                        {...{
                                            sortOrder,
                                            sortKey,
                                        }}
                    ...
                    <tbody>
                        {filteredRecords.slice(firstIndex, lastIndex).map((order, index) => {
                            return (
