        ...
        <a href="#">
            <div className="w-72 h-80 bg-white rounded-3xl shadow-xl">
                ...
                <div className="mt-3 px-4">
                    <h5 className="mb-2 text-lg font-bold tracking-tight text-gray-900">{props.name}</h5>
                    <div className="flex items-center">
                        ...
                        <span  className="px-1.5 mr-1.5 font-light">{props.rating}</span>
                        <div className="border-r h-4 border-gray-300"></div>
                        <span className="px-1.5 ml-1.5 font-light">{props.openinghour} - {props.closinghour}</span>
                    </div>
                    <div className="pl-1.5 mt-2 flex">
                        ...
                        <span className="px-3">Rp.{props.lowestprice} - Rp.{props.highestprice}</span>         
                    </div>
                </div>
            </div>
        </a>
