                ...
                <div className="relative bg-gray-100 rounded-lg">
                    ...
                    <form action="#" className="p-4 md:p-5">
                        ...
                        <div className="flex flex-col items-center justify-center">
                            <button type="submit" className="text-white inline-flex items-center bg-mealshub-blue hover:bg-gray-500 focus:ring-4 focus:outline-none focus:ring-blue-100 font-medium rounded-full text-sm px-5 py-2.5 text-center" onClick={props.onClose}>
