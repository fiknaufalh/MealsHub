export default function RoleCard() {
    return (
        <div className="w-3/4 bg-white rounded-3xl shadow-xl py-8 px-10">
            <h1 className="text-mealshub-orange text-3xl font-bold mb-12">Who Are You?</h1>
            <button type="button" className="flex text-white bg-mealshub-orange font-bold rounded-3xl p-4 w-full inline-flex hover:shadow-xl mb-7">
                    ...
                    <a href="#" className="flex items-center rounded-lg group">
                        <div className="absolute group text-mealshub-orange ms-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 45 45" fill="none">
                                <mask id="mask0_60_761" maskUnits="userSpaceOnUse" x="5" y="1" width="35" height="43">
                                    <path d="M13.125 3.75V41.25M7.5 4.6875V14.0625C7.5 18.75 13.125 18.75 13.125 18.75C13.125 18.75 18.75 18.75 18.75 14.0625V4.6875M31.875 18.75V41.25" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M37.5 11.25C37.5 15.3919 34.9819 18.75 31.875 18.75C28.7681 18.75 26.25 15.3919 26.25 11.25C26.25 7.10812 28.7681 3.75 31.875 3.75C34.9819 3.75 37.5 7.10812 37.5 11.25Z" fill="white" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                </mask>
                        ...
                        <span className="flex ms-14 whitespace-nowrap text-2xl text-left">Customer</span>
                    </a>
                </div>
            </button>
            <button type="button" className="flex text-white bg-mealshub-orange font-bold rounded-3xl p-4 w-full inline-flex hover:shadow-xl mb-7">
