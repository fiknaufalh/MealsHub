...
const EditForm: React.FC<EditFormProps> = (props) => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            await Axios.patch(`http://localhost:8000/products/${props.idMenu}`, {
                name: formData.name,
                ...
                <div className="relative bg-gray-200 opacity-100 rounded-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="p-4 md:p-5">
                        ...
                        <div className="flex flex-col items-center justify-center">
                            <button className="text-white inline-flex items-center bg-mealshub-blue hover:bg-gray-500 focus:ring-4 focus:outline-none focus:ring-blue-100 font-medium rounded-full text-sm px-5 py-2.5 text-center">
                                Edit Product
                            </button>
                        </div>
                    </form>
