            ...
            <div className="flex bg-white md:flex-row mx-16">
                <div className="flex flex-row leading-normal w-full border-b border-gray-300 pb-10">
                    ...
                    <div className="flex flex-col ms-12">
                        <h4 className="w-full font-bold text-3xl text-gray-900 text-left my-4">{name}</h4>
                        <p className="w-full font-normal text-lg text-gray-500 text-left mb-2">{description}</p>
                        <div className="flex items-center my-2 w-full">
                            ...
                            <span  className="px-1.5 mr-1.5 text-lg font-normal text-gray-500">{rating}</span>
                            <div className="border-r h-4 border-gray-300"></div>
                            <span className="px-1.5 ml-1.5 text-lg font-normal text-gray-500">{openinghour} - {closinghour}</span>
                        </div>
                        <div className="flex items-center pl-1.5 mt-2">
                            ...
                            <span className="px-3 font-normal text-lg text-gray-500">Rp.{lowestpriceidr} - Rp.{highestpriceidr}</span>         
                        </div>
                    </div>
                </div>
            </div>
