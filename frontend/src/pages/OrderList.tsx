...
export default function OrderList() {
    ...
    const getData = async () => {
        const tableResponse = await Axios.get(`http://localhost:8000/tables/${tableid}`);
        ...
        const ordertable = orderData.filter((order: Order) => order.id_table === tableData.id);
            ...
            <div className="col-span-4">
                <div className="ms-20">
                    ...
                    <div className="row-span-7 mt-6 mb-9 py-12 w-11/12 bg-white rounded-3xl">
                        <div className="">
                            <h2 className="text-mealshub-red text-3xl font-bold ms-16">Your Order</h2>
                            <OrderCard data={joinedData}/>
                        </div>
                    </div>
                </div>
            </div>
