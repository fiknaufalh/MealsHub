                                ...
                                <>
                                    <div className="flex py-10 mx-16 border-t border-mealshub-red justify-between items-center">
                                        ...
                                        <h3 className="text-black text-2xl font-bold">
                                            Rp {" "}
                                            {totalAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")},00
                                        </h3>
                                    </div>
                                    <div className="flex mx-16 justify-center">
                                        <button className="w-full text-white bg-mealshub-red font-bold text-lg rounded-full px-5 py-2.5 text-center shadow-xl">
                                            Checkout
                                        </button>
                                    </div>
                                </>
